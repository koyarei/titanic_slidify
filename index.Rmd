...
2. The project focuses on the magical input to output behavior of ML
3. No more coding needed. Anyone can understand what ML is doing in 5 seconds.
---

## Next step

1. Hpefully more audience can be interested in ML, and find more resources to continue studying  
